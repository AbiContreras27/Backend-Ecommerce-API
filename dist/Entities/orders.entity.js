...
let Order = class Order {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, date: { required: true, type: () => Date }, orderDetails: { required: true, type: () => require("./orderDetails.entity").OrderDetails }, user: { required: true, type: () => require("./users.entity").User } };
    }
};
exports.Order = Order;
__decorate([
