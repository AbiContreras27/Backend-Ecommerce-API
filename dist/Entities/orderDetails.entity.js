...
let OrderDetails = class OrderDetails {
    static _OPENAPI_METADATA_FACTORY() {
        return { id: { required: true, type: () => String }, price: { required: true, type: () => Number }, products: { required: true, type: () => [require("./products.entity").Products] }, order: { required: true, type: () => require("./orders.entity").Order } };
    }
};
